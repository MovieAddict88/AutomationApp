...
.method logGoAway(Lio/grpc/okhttp/OkHttpFrameLogger$Direction;ILio/grpc/okhttp/internal/framed/ErrorCode;Lokio/ByteString;)V
    ...
    const-string v2, " GO_AWAY: lastStreamId="
    ...
    .line 178
    invoke-virtual {p2, p4}, Lokio/Buffer;->write(Lokio/ByteString;)Lokio/Buffer;

    move-result-object p2

    invoke-static {p2}, Lio/grpc/okhttp/OkHttpFrameLogger;->toString(Lokio/Buffer;)Ljava/lang/String;
...
.method public logPriority(Lio/grpc/okhttp/OkHttpFrameLogger$Direction;IIIZ)V
    ...
    const-string v2, " PRIORITY: streamId="
    ...
    const-string p2, " streamDependency="
...
.method logWindowsUpdate(Lio/grpc/okhttp/OkHttpFrameLogger$Direction;IJ)V
    ...
    const-string p2, " windowSizeIncrement="
